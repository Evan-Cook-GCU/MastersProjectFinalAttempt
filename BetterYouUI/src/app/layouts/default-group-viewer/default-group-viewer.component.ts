...
@Component({
  selector: 'app-default-group-viewer',
  standalone: true,
  ...
  templateUrl: './default-group-viewer.component.html',
  styleUrl: './default-group-viewer.component.scss'
})
export class DefaultGroupViewerComponent  implements OnInit {
